...
echo Installing packages required: tcl pax python-devel fakeroot elfutils-libelf-devel
sudo yum -y install tcl pax python-devel fakeroot elfutils-libelf-devel
